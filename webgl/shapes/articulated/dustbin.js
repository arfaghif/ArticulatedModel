class Dustbin extends ArticulatedShape {
    constructor(color, center, rotation, scale) {
        ...
        this.addChild(new ArticulatedShape('dustbin-comp', new Cube(colors, nextChildCenter, nextChildRotation, nextChildScale),-360,360, 2,[1,0,0] , translate, center, rotation, scale,3));
        ...
        translate = [0, 0.375 ,0];
        this.child[0].addChild(new ArticulatedShape('dustbin-comp', new Cube(colors, nextChildCenter, nextChildRotation, nextChildScale),-360,360, 2,[0,1,0] , translate, center, rotation, scale));
